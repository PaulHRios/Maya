...
const I18N = (() => {
  ...
  const EN = {
    ...
    // pantalla de presentación / login
    'Todo el cuidado de tu bebé en un solo lugar, privado y en tu teléfono: tomas, sueño, pañales, salud y sus primeros logros.': "Everything for your baby in one place, private and on your phone: feeds, sleep, diapers, health and their first milestones.",
    'Tomas y lactancia': 'Feeds & breastfeeding', 'Timers de pecho, biberón y extracción': 'Breast, bottle & pumping timers',
    'Sueño y rutinas': 'Sleep & routines', 'Ventanas de descanso y bitácora nocturna': 'Wake windows & night logbook',
    'Pañales con análisis': 'Diapers with analysis', 'Color y consistencia, con foto opcional': 'Color & consistency, with optional photo',
    'Refri y congelador siempre al día': 'Fridge & freezer always up to date',
    'Retos por etapa': 'Goals by stage', 'Estimulación temprana según su edad': 'Age-based early stimulation',
    'Un chequeo privado, solo para ti': 'A private check-in, just for you',
    '🧪 Probar el demo': '🧪 Try the demo', 'Datos de ejemplo · nada se guarda': 'Sample data · nothing is saved',
    'Entrar a nuestra cuenta': 'Sign in to our account',
